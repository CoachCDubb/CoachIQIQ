...
function getProgramPointLabels_() {
  const mascotName = normalizeMascotName_(getSetting("Mascot Name"));
  return {
    points: mascotName ? mascotName + " Points" : "Program Points",
    leaderboard: mascotName ? mascotName + " Leaderboard" : "Program Leaderboard"
  };
}
