...
DEFAULT_SOURCE = ROOT / "docs" / "CoachIQ-New-Program-Launch-Guide.md"
DEFAULT_OUTPUT = ROOT / "docs" / "CoachIQ-New-Program-Launch-Guide.pdf"
...
def build_pages(source):
    ...
    for kind, text in guide_lines(source):
        if kind == "space":
            y -= 5
        elif kind == "title":
...
if __name__ == "__main__":
    ...
    write_pdf(build_pages(args.source), args.output)
    print(args.output)
