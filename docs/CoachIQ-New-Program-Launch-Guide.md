...
- In Settings, set `Setup Complete` to `FALSE` for a true first-run test.
...
3. Complete Program Name, School / Organization, Mascot / Team Name, Current Season, and Sport.
