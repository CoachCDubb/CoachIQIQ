...
1. Open the web app URL in Safari and sign in with the same email listed in the
   CoachIQ Staff directory.
2. Test Dashboard, Players, a practice session, and Live Game before game day.
3. Tap Safari's **Share** button.
4. Select **Add to Home Screen**.
5. Name it **CoachIQ** and select **Add**.
